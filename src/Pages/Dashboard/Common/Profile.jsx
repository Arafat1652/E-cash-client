    ...
    <div>
      <div className="flex flex-col lg:flex-row gap-4 mt-30">
                <div className="flex-1 bg-indigo-100 border border-indigo-200 rounded-xl p-6 animate-fade-in">
                    <h2 className="text-3xl md:text-5xl text-blue-900">
                    <strong>{user.name.toUpperCase()}!</strong>
                      <span className="text-xl"><br />Check Balance</span>  
                    </h2>
                    <span
        ...
        {user.balance} tk
...

                {
                    ...
                    <strong>System</strong>
                      <span className="text-xl"><br />Total Balance</span>  
                    </h2>
              ...
              {totalBalance !== null ? `${totalBalance} tk` : "Loading..."}
                    ...
                    <Link to="/dashboard/transaction" className="inline-block mt-8 px-8 py-2 text-xl font-bold text-white bg-blue-800 hover:bg-blue-900 transition-transform">
                       My Transaction
                    </Link>
                </div>
                }  
